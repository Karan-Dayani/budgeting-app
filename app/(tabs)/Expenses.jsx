import { View, Text, ScrollView, SafeAreaView, Pressable, Modal, TextInput } from "react-native";
    ...
    <View className="px-5 flex-1">
      <Stack.Screen
        options={{
          ...
          headerTitleStyle: { color: "white", fontFamily: "Nunito", fontSize: 25 },
      ...
      <SafeAreaView>
        <View className="my-4 flex-row justify-between items-center">
          <View>
            <Text className="text-2xl text-white font-bold">Expenses Summary</Text>
            <Text className="text-lg text-gray-400">Overview of your monthly expenses</Text>
          </View>
          <Pressable onPress={handleAddExpense} className="bg-blue-500 p-2 rounded-full">
